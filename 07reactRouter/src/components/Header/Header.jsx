...
// link is used in place of a tag, as a tag refreshes the complete page.
// navlink has the same functionality as link with some extra features.
// in link and navlink we use  * to="/" * instead of href
